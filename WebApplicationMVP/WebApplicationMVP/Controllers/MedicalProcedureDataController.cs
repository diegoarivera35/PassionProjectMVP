...
namespace WebApplicationMVP.Controllers
{
    public class MedicalProcedureDataController : ApiController
    {
        ...
        /// <summary>
        /// Gathers information about all medicalprocedures related to a particular doctor ID
        /// </summary>
        /// <returns>
        /// HEADER: 200 (OK)
        /// CONTENT: all medicalprocedures in the database, including their associated doctor matched with a particular doctor ID
        /// </returns>
        ...
        {
            //SQL Equivalent:
            //Select * from medicalprocedures where medicalprocedures.doctorid = {id}
        ...
        /// <returns>
        /// HEADER: 200 (OK)
        /// CONTENT: all medicalprocedures in the database, including their associated doctor that match to a particular patient id
        /// </returns>
