namespace WebApplicationMVP.Migrations
{
    using System;
    ...
    public partial class tables : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        MedicalProcedure_MedicalProcedureID = c.Int(),
                    })
                .PrimaryKey(t => t.PatientID)
                .ForeignKey("dbo.MedicalProcedures", t => t.MedicalProcedure_MedicalProcedureID)
                .Index(t => t.MedicalProcedure_MedicalProcedureID);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Patients", "MedicalProcedure_MedicalProcedureID", "dbo.MedicalProcedures");
            DropForeignKey("dbo.MedicalProcedures", "PatientID", "dbo.Patients");
            DropForeignKey("dbo.MedicalProcedures", "Patient_PatientID", "dbo.Patients");
            ...
            DropIndex("dbo.Patients", new[] { "MedicalProcedure_MedicalProcedureID" });
            DropIndex("dbo.MedicalProcedures", new[] { "Patient_PatientID" });
